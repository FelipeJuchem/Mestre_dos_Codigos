...
namespace Exercicio3
{
    public class Program
    {
        ...
        public static void NovaContaCorrente(int numeroConta)
        {
        ...
        public static void NovaContaEspecial(int numeroConta)
        {
        ...
        {
            var lista = listaContasCorrentes.OrderBy(x => x.NumeroDaConta);
            foreach(var conta in lista)
            {
                Console.WriteLine("\nConta Corrente:\n" +
                    $"Numero da Conta: {conta.NumeroDaConta}  Saldo: {conta.Saldo.ToString("N2")}");
            }
            var lista2 = listaContasEspeciais.OrderBy(x => x.NumeroDaConta);
            foreach (var conta in lista2)
            {
                Console.WriteLine("\nConta Especial:\n" +
                    $"Numero da Conta: {conta.NumeroDaConta}  Saldo: {conta.Saldo.ToString("N2")}");
            }
